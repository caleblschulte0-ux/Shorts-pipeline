...
# The expr_extra configs use the STRUCTURED form — the production path the
# money-goes beats author — so the tests exercise emotion selection, windows
# and intensity, not just the legacy boolean (which parse_expression_config
# still accepts and test_perf covers).
TEST_CASES = [
    ExpressionTestCase(
        name="paycheck",
        ...
        label="YOU'LL EARN",
        base_extra=None,
        expr_extra={"expression": {"emotion": "joy", "intensity": 0.8}},
    ),
    ExpressionTestCase(
        name="taxes",
        scene_fn="tax_scene",
        ...
        base_extra=None,
        expr_extra={"expression": {"emotion": "shock", "intensity": 0.8}},
    ),
    ExpressionTestCase(
        name="housing",
        scene_fn="rent_scene",
        ...
        base_extra=None,
        expr_extra={"expression": {"emotion": "burden", "intensity": 0.9}},
    ),
    ExpressionTestCase(
        name="transportation",
        scene_fn="gas_scene",
        ...
        base_extra=None,
        expr_extra={"expression": {"emotion": "frustration", "intensity": 0.8}},
    ),
    ExpressionTestCase(
        name="treadmill",
        ...
        base_extra=None,
        expr_extra={"expression": {"emotion": "exhaustion", "intensity": 0.9}},
    ),
    ExpressionTestCase(
        name="money_drain",
        ...
        expr_extra={"upto": 1, "final": False,
                    "expression": {"emotion": "resignation", "intensity": 0.8}},
    ),
]
